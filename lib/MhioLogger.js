...
class MhioLogger {
  ...
  /**
   * Returns a logger instance in the logger namespace
   * @param {string} namespace_suffix           - The suffix to append to the base namespace
   * @returns {object}                          - `pino` instance
   */
  ...
  /**
   * Return a debug instance in the logger namespace
   * @param {string} namespace_suffix           - The suffix to append to the base namespace
   * @returns {function}                        - `debug` instance
   */
  ...
  /**
   * @typedef {Object} LoggerAndDebug
   * @property {object}     logger            - `pino` instance
   * @property {function}   debug             - `debug` instance
   */
